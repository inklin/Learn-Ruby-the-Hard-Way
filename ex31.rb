...
if door == "1"
  ...
  if bear == "1"
    ...
    puts "The bear invites you to sit down for cake."
  else
  ...
  puts "You find yourself on the surface on the moon."
  puts "1. Plant a flag."
  ...
  puts "You stumble around anf dall on a knife and die. Good job!"
end